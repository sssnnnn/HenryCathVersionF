                                ...
                                <div class="modal-body">
                                 ...
                                 <form action="{{ route('commandes.store') }}" method= "POST">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="row options">
                                            <div class="col-6">
                                                <select id="etat" name="etat_id" class="form-select" aria-label="Default select example"
                                                   >
                                            ...
                                            <div class="col-6">
                                                <input type="text" class="form-control" id="inputToDisplay" name="controle" style="display:none"  >
                                            </div>
